...
public class Grade9LandingDashboard extends JPanel {

    private final AuthenticationService authService;
    private Runnable onAttendance;
    private Runnable onLogout;

    public Grade9LandingDashboard(AuthenticationService authService) {
    ...
    private void buildUI() {
        // ── Header (identical structure to Grade 11) ─────────────────────────
        ...
        // ── Cards grid (same GridBagLayout as Grade 11, single card) ────────
    ...
    // Identical to Grade11LandingDashboard's buildCard (same size, same padding)
